...
export type AccountCreateInput = {
  ...
  externalIdentity?: InputMaybe<AccountExternalIdentityInput>;
...
export type AccountCreatePayload = {
  ...
  errors?: Maybe<Array<AccountCreateErrorsUnion>>;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getAnimesKitsu(variables: GetAnimesKitsuQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetAnimesKitsuQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetAnimesKitsuQuery>(GetAnimesKitsuDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getAnimesKitsu', 'query');
    },
    getEpisodeKitsu(variables: GetEpisodeKitsuQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetEpisodeKitsuQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetEpisodeKitsuQuery>(GetEpisodeKitsuDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getEpisodeKitsu', 'query');
    }
  };
}
